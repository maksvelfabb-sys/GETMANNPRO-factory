...
def render_order_card(order):
    ...
    with container.expander("🛠 Товари та Креслення"):
        ...
        # Виправляємо проблему з типом даних телефону (dtype)
        ...
        # ВИПРАВЛЕНО: width='stretch' замість use_container_width
        ...
        if st.button("💾 Зберегти", key=f"sv_{oid}", type="primary", width="stretch"):
            ...
            # ВАЖЛИВО: Виправляємо FutureWarning. Примусово робимо колонки рядковими.
